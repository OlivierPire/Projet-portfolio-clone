		...
		<div className="hero-movie">
			...
			<div className="hero-informations">
                ...
                <div className="hero-buttons">
                    <button className="hero-play-btn btn"><FontAwesomeIcon icon={faPlay} className='play-icon' />Lecture</button>
                    <button className="hero-infos-btn btn"><FontAwesomeIcon icon={faInfoCircle} className='infos-icon' />Plus d'infos</button>
                </div>
			</div>
		</div>
	);
